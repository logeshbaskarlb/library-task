  ...
  return (
    <>
      <div className="d-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-black-800">Books List</h1>
        <Link
          to="/addbook"
          className="d-flex d-sm-inline-block btn btn-sm btn-primary shadow-sm"
        >
          <i className="fas fa-download fa-sm text-white-50" /><strong>+</strong> Add New Book
        </Link>
      </div>

      <div className="card shadow mb-4" style={{ borderRadius: "50px" }}>
        <div className="card-header py-3 rounded-5">
          <h6 className="m-0 font-weight-bold text-primary">Current Books</h6>
