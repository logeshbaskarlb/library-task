      ...
      <div className="row justify-content-center align-content-center mt-5">
        <div className="  col-sm-12">
          <div className="card text-center shadow">
            <div className="card-header h3">Book Details</div>
              ...
              {loading ? (
                ...
                <div className="table-responsive mx-lg-5">
                  <table className="table table-bordered table-striped">
                    <tbody>
                      <tr>
                        <td className="text-center">Tile of The Book</td>
                        <td className="">{books.title}</td>
                      </tr>
                      <tr>
                        <td className="text-center">Name of Author</td>
                      ...
                      <tr>
                        <td className="text-center">Date of Published</td>
                        <td>{books.dop}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td className="text-center">Author bio-graphy</td>
            ...
            <div className="card-footer text-body-secondary">
              <div className="text-center">
                <Link to={"/"} className="btn btn-primary px-lg-5">
                  Back to Table
                </Link>
              </div>
            </div>
